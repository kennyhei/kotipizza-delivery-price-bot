...
i18n = {
    'fi': {
        ...
        'poll_success': 'Viimeisin kuljetushinta on {price_str} € ({estimate} min.). Aika tilata! 🍕 https://kotipizza.fi',
        'help': (
    ...
    'en': {
        ...
        'poll_success': 'Current delivery price is {price_str} € ({estimate} min.). Time to order! 🍕 https://kotipizza.fi',
        'help': (
